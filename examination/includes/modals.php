      ...
      <div class="modal-body">
        <div class="col-md-12">
          <div class="form-group">
            ...
            <?php 
               $selMe = $conn->query("SELECT * FROM users WHERE id='$exmneId' ")->fetch(PDO::FETCH_ASSOC);
             ?>
            <input type="radio" name="asMe" value="<?php echo $selMe['username']; ?>"> <?php echo $selMe['username']; ?> <br>
